...
# sphinx-quickstart on Tue Jun  1 11:25:15 2010.
#
...
version = str(sversion[0]) + "." + str(sversion[1]) + "." + str(sversion[2])
...
def addlink(typ, rawtext, text, lineno, inliner, options={}, content=[]):
    env = inliner.document.settings.env
    link = env.config[text]
    pnode = nodes.reference(link[0], link[0], refuri=link[1])
    return [pnode], []

def setup(app):
    app.add_config_value('link', False, False)
...
# links
#links = {
#    'varname':  ('description': 'URL'),
#    'varname2': ('description2': 'URL2'),
#    }
...
latex_documents = [
  ('contents', 'Speect.tex', u'Speect Documentation',
   u'Aby Louw', 'manual'),
]
