...
from doxybridge.finder.doxygen import index as indexfinder
from doxybridge.finder.doxygen import compound as compoundfinder

from doxybridge.parser.doxygen import index, compound
